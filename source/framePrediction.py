...
for i in range(1, 40):
    ...
    history = model.fit_generator(utility.data_generator(isTrain = True, isGAN = False, close_far_all = 3, batchSize = 10), steps_per_epoch = 4000, epochs = 1)
    loss[i] = model.evaluate_generator(utility.data_generator(isTrain = False, isGAN = False, close_far_all = 3, batchSize = 20), steps = 250)
