...
model_judge.load_weights('./trained_models/model_epoch_22.hdf5')
...
while True:
    ...
    depth = model_judge.predict_on_batch([x, x1, x2])
...
for i in range(1, total+1):
    ...
    xPred /= 255
    close = model_close.predict_on_batch(xPred)
    far = model_far.predict_on_batch(xPred)
    depth = model_judge.predict_on_batch([xPred,  far[5], close[5]])
